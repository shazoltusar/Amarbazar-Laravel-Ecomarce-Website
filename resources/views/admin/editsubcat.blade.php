...
@section('page_title')
    Edit Sub Category - Amar Bazar
@endsection
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-1 mb-4"><span class="text-muted fw-light">Page/</span> Edit Sub Category</h4>
        <!-- Basic with Icons -->
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{route('updatesubcat')}}" method="POST">
                        @csrf
                        <input type="hidden" name="subcatid" value="{{$subcatinfo->id}}" id="">
                        <div class="row mb-3">
