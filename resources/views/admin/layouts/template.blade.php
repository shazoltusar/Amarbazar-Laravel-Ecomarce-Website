        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              <span class="app-brand-text demo menu-text fw-bolder ms-2">AmarBazar</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <a href="{{route('addcatetory')}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
                  <div data-i18n="Analytics">Add Category</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="{{route('allcatetory')}}" class="menu-link">
                  <i class="menu-icon tf-icons bx bx-home-circle"></i>
              ...
              <li class="menu-item">
                  <a href="{{route('addsubcatetory')}}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle"></i>
                    <div data-i18n="Analytics">Add Sub Category</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('allsubcatetory')}}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-home-circle"></i>
