...
<body>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="custom_menu">
                            <ul>
                                <li><a href="{{route('pendingorders')}}">Customar Dashbord</a></li>
                                <li><a href="">Gift Ideas</a></li>
                                <li><a href="{{ route('newrelease') }}">New Releases</a></li>
                                <li><a href="{{ route('todaydeals') }}">Today's Deals</a></li>
                                <li><a href="{{ route('customarservice') }}">Customer Service</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="containt_main">
                    <div id="mySidenav" class="sidenav">
                        ...
                        @foreach ($categories as $category)
                            <a href="{{route('category', [$category->id, $category->slug])}}">{{ $category->categori_name }}</a>
                        @endforeach
                    </div>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                           @foreach ($categories as $category)
                              <a class="dropdown-item" href="{{route('category', [$category->id, $category->slug])}}">{{ $category->categori_name }}</a>
                           @endforeach
                        </div>
                    </div>
                    <div class="main">
    ...
    <div class="footer_section layout_padding">
        <div class="container">
            <div class="footer_logo"><a href="{{ route('home') }}"><img
                        src="{{ asset('home/images/footer-logo.png') }}"></a></div>
            <div class="input_bt">
            ...
            <div class="location_main">Contruct Number : <a href="#">+880 17212-64809</a></div>
        </div>
    </div>
    <!-- footer section end -->
    ...
    <div class="copyright_section">
        <div class="container">
            <p class="copyright_text"> Develop By Mr. Shazol Tusar © 2023.</p>
        </div>
    </div>
